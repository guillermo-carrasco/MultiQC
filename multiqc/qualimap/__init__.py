...
class MultiqcModule(multiqc.BaseMultiqcModule):
    ...
    def qualimap_stats_table(self):
        ...
        config.general_stats['headers']['median_coverage'] = '<th class="chroma-col" data-chroma-scale="RdYlGn"><span data-toggle="tooltip" title="Qualimap: Median coverage">Coverage</span></th>'
